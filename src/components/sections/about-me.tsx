      ...
      <div className="flex w-full flex-col justify-between gap-12 md:flex-row">
        ...
        <div className="flex max-w-xl flex-col gap-6">
          ...
          <Typography>
            ...
            various personal and academic projects, constantly pushing myself to
            learn more — from mastering Tailwind CSS and TypeScript to exploring
            full stack tools like Next.js.
          </Typography>
          <Typography>
            I love crafting clean, responsive, and user-focused interfaces. For
            me, good design is not just about how things look, but also how they
            work. That’s why I focus on building digital products that are both
            visually appealing and technically sound.
          </Typography>
          <Typography>
            If you&apos;d like to connect, chat about tech, or check out some of
            the projects I&apos;m working on, feel free to visit my.{" "}
            <Link
              noCustomization
              externalLink
              withUnderline
