...
function Background() {
  ...
  return (
    <div
      ref={containerRef}
      className="-z-1 absolute inset-0 flex h-full w-full flex-row justify-between bg-gradient-to-t from-indigo-900/10 to-indigo-950/5"
    >
      <div
        style={{
          background:
        ...
        className="absolute inset-0 top-1/2 h-full w-full rounded-full opacity-10"
      />
